...
const PageHero = ({
  ...
  return (
    <section className="relative flex  h-screen items-center bg-no-repeat overflow-hidden" 
    // style={{
  ...
  />
      ...
      <div className="relative  px-10 pb-14 md:px-14 max-w-xl">
       ...
       {timeDate &&<p className="text-[15px] mb-5 font-light leading-relaxed text-white/70 max-w-[420px]">
          {timeDate}
        </p>}  
...
{ social &&<div className="mt-12 flex items-center gap-6">
