...
const ArticleCard = ({
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-[12px] border border-gray-100 bg-white shadow-sm">
      {/* Image */}
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        {/* Category pill */}
        <span
          className="w-fit rounded-full px-3 py-1 text-[#00205B] bg-[#EEF1F7] text-[10px] uppercase tracking-wide"
