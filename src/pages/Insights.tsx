      ...
      <Wrapper className='grid grid-cols-1'>
   ...
   
        {
          articles.map((article) => (
               ...
               <ArticleCard key={article.link} category={article.pillword} title={article.description} readTime={`${article.time}`} imageSrc={article.image} href={article.link} date=''/>
